...
const PlanSelectorModal = ({ isOpen, onClose }) => {
  ...
  const plans = [
    {
      ...
      features: [
        ...
        { icon: <FaServer className="text-blue-400" />, text: "50GB Bandwidth", highlight: false },
    ...
    },
    {
      ...
      features: [
        ...
        { icon: <FaKey className="text-blue-400" />, text: "2 API Keys per Project", highlight: false },
        { icon: <FaInfinity className="text-purple-500" />, text: "Unlimited Bandwidth", highlight: true },
  ...
  if (showCart && selectedPlan) {
    return (
      <div className={`fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 transition-opacity duration-300 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
        <div className="bg-gray-900 rounded-2xl w-full max-w-2xl border border-gray-700 shadow-2xl overflow-hidden transform transition-all duration-300 scale-[0.98] hover:scale-100">
          ...
          <div className="p-6 grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-900/20 to-purple-900/30 rounded-xl p-6 border border-blue-500/30">
              ...
              <p className="text-gray-400 text-sm mb-4">
                Renews at ₹499/month after {selectedMonths} months. Cancel anytime.
              </p>
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              ...
              <div className="mb-6 bg-blue-900/20 p-3 rounded-lg border border-blue-800/30">
                <h4 className="text-blue-300 text-sm mb-1">Taxes</h4>
                <p className="text-blue-400 text-xs">
                  Will be calculated based on your billing address
                </p>
              </div>
              ...
              <div className="flex justify-between items-center py-4 border-t border-gray-700 mt-4">
                <div>
                  ...
                  <p className="text-gray-500 text-xs">Excluding taxes</p>
                </div>
              ...
              <div className="mt-5 pt-4 border-t border-gray-700">
                ...
                <div className="mt-4 flex justify-center items-center gap-2">
                  <div className="bg-yellow-500/10 px-2 py-1 rounded text-yellow-400 text-xs">
                    30-day guarantee
                  </div>
                  <div className="bg-green-500/10 px-2 py-1 rounded text-green-400 text-xs">
                    Cancel anytime
                  </div>
                </div>
              </div>
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 transition-opacity duration-300 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      <div className={`bg-gray-900 rounded-2xl p-6 w-full max-w-4xl border border-gray-700 shadow-2xl transform transition-all duration-300 ${isVisible ? 'scale-100' : 'scale-95'}`}>
        <div className="flex justify-between items-center mb-6 pb-4 border-b border-gray-800">
          <h2 className="text-white text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
            Choose Your Plan
          </h2>
          <button onClick={onClose} className="text-gray-400 hover:text-white transition-colors">
        ...
        <div className="mt-8 bg-gradient-to-r from-gray-800/50 to-gray-900/50 border border-gray-700 rounded-xl p-6">
          <h3 className="text-white text-lg font-semibold mb-4 flex items-center gap-2">
            <FaBolt className="text-yellow-400" /> AI Tools Included in All Plans
          </h3>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-4">
          <div className="bg-blue-900/20 px-3 py-1.5 rounded-full text-blue-400 text-sm border border-blue-800/30">
             Secure payments
          </div>
          <div className="bg-purple-900/20 px-3 py-1.5 rounded-full text-purple-400 text-sm border border-purple-800/30">
             Instant activation
          </div>
          <div className="bg-green-900/20 px-3 py-1.5 rounded-full text-green-400 text-sm border border-green-800/30">
